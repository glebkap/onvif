...
import (
	...
	goonvif "github.com/glebkap/onvif"
	"github.com/glebkap/onvif/device"
	sdk "github.com/glebkap/onvif/sdk/device"
	"github.com/glebkap/onvif/xsd/onvif"
)
...
func main() {
	...
	if err != nil {
		...
		// You could use https://github.com/glebkap/onvif/gosoap for pretty printing response
